		...
		<div id="content">
			<c:if test="${!empty authInfo }">
				...
				<form action="<%=request.getContextPath()%>/add" method="post"
					id="groupAdd_form" name="groupAdd_form"
				...
				src="<%=request.getContextPath()%>/images/basic.png"> <br> 
					...
					<table id="groupTable">
						<tr>
							<td class="tdleft" style="width: 130px;">카테고리 <font
								color="red"><b>*</b></font>
							</td>
						...
						<tr>
							...
							<td class="tdRight"><input type="text" id="grpName"
								...
								id="grpNameConfirmResult"></span> <input type="hidden"
								id="confirmBtn" value="0" /></td>
						</tr>
						<tr>
						...
						<tr>
							<td id="tdbottom" colspan="3"><input type="button"
								...
								type="button" id="btnbottom" value="취소"
