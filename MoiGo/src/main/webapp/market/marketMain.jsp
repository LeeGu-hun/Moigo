            ...
            <div class="window">
               ...
               <div id="writeBoard" style="background: white;">
                  ...
                  <form action="market/addProduct" method="post"
                     ...
                     상품명 : <input type="text" id="productName" name="productName" /><br><br>
                     &nbsp;&nbsp;가격 : <input type="text" id="productPrice" name="productPrice" 
                        onkeydown="return onlyNumber(event)" onkeyup="removeChar(event)" style="ime-mode:disabled;" /><br><br>
                     &nbsp;&nbsp;내용 : <input type="text" id="productContent" name="productContent" /><br><br>
