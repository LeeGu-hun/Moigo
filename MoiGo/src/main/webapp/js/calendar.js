...
function calendar(tYear,tMonth){ //달력 함수  
    ...
    if (tMonth==null)   //null 일경우, 처음 페이지가 로드 될때의 월은  
        ...
        calendarStr  = "<TABLE style='height: 250px;'>"  
        ...
        calendarStr +="</TR><TR align=center><TD colspan=7 style='width: 250px;'><input name=selDate class=selDate type=hidden readonly></TD></TR></TABLE>"        
